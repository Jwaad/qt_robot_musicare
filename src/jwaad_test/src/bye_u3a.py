...
def Main():
    qt_emote("grin")
    qt_say("That was a lot of fun!")
    rospy.sleep(2)
    qt_emote("talking")
    qt_say("If you would also like to hang out with me again, please book an appointment with my colleagues!")
    rospy.sleep(3)
    qt_say("Thanks for coming !... BYEEE")
    qt_gesture("wave")
...
if __name__ == '__main__':
    #Initialise game
    rospy.init_node('Bye_U3A', anonymous=False)
