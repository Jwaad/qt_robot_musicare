...
class QTManager():
    ...
    def init_robot(self, arm_vel):
        ...
        self.wait_persistent_service('/qt_robot/motors/setControlMode',1)
        ...
        self.wait_persistent_service('/qt_robot/motors/setVelocity',1)
    ...
    def qt_say_blocking(self, text, black_screen = False):
        ...
        # Start multi thread, to loop emote
        emote_looper = threading.Thread(target=self.loop_emote,
                                        args=("talking", self.talking_anim_time, timer_len),
                                        daemon=True)
        emote_looper.start()  # Start multi_threaded function
        # Block until speech timer is finished
        talking = True
