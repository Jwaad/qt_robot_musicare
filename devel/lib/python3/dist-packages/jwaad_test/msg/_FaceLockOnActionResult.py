...
"""autogenerated by genpy from jwaad_test/FaceLockOnActionResult.msg. Do not edit."""
import codecs
import sys
...
class FaceLockOnActionResult(genpy.Message):
  _md5sum = "c946c718f1f128b4782e37af30ca51f2"
  _type = "jwaad_test/FaceLockOnActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','jwaad_test/FaceLockOnResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FaceLockOnActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = jwaad_test.msg.FaceLockOnResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = jwaad_test.msg.FaceLockOnResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.completed,) = _get_struct_B().unpack(str[start:end])
