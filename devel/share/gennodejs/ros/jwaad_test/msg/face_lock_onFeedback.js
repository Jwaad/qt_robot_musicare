...
class face_lock_onFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new face_lock_onFeedback(null);
  ...
  static datatype() {
    ...
    return 'jwaad_test/face_lock_onFeedback';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new face_lock_onFeedback(null);
...
module.exports = face_lock_onFeedback;
