...
class FaceLockOnActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new FaceLockOnResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FaceLockOnResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FaceLockOnActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = FaceLockOnResult.Resolve(msg.result)
    }
    else {
      resolved.result = new FaceLockOnResult()
    }
...
module.exports = FaceLockOnActionResult;
