...
class face_lock_onResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new face_lock_onResult(null);
  ...
  static datatype() {
    ...
    return 'jwaad_test/face_lock_onResult';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new face_lock_onResult(null);
...
module.exports = face_lock_onResult;
