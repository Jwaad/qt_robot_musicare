...
(cl:in-package qt_memgame_app-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <suspend-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'suspend-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_memgame_app-srv:<suspend-request> is deprecated: use qt_memgame_app-srv:suspend-request instead.")))

(cl:ensure-generic-function 'flag-val :lambda-list '(m))
(cl:defmethod flag-val ((m <suspend-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_memgame_app-srv:flag-val is deprecated.  Use qt_memgame_app-srv:flag instead.")
  (flag m))
...
(cl:defmethod cl:initialize-instance :after ((m <suspend-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'suspend-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_memgame_app-srv:<suspend-response> is deprecated: use qt_memgame_app-srv:suspend-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <suspend-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_memgame_app-srv:status-val is deprecated.  Use qt_memgame_app-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<suspend-response>)))
  ...
  "qt_memgame_app/suspendResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'suspend-response)))
  "Returns string type for a service object of type 'suspend-response"
  "qt_memgame_app/suspendResponse")
